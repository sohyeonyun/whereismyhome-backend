...
//	Swagger-UI 3.x 확인
//	http://localhost[:9999]/{your-app-root}/swagger-ui/index.html
	...
	private ApiInfo apiInfo() {
		...
		descript += "<img src=\"http://localhost:9999/home/static/assets/img/ssafy_logo.png\">";
...
//				.termsOfServiceUrl("https://edu.ssafy.com")
	...
	public Docket commentApi() {
		return getDocket("공지사항 댓글", Predicates.or(PathSelectors.regex("/comment.*")));
	}
	...
	public Docket mapApi() {
		return getDocket("맵", Predicates.or(PathSelectors.regex("/map.*")));
	}
